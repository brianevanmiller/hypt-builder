...
- hypt-plan-critic: Critical plan review — find gaps, ask questions, and refine before building. Use when the user wants a plan critiqued before implementation, including `/plan-critic`, `hypt:plan-critic`. (aliases: `/plan-critic`, `hypt:plan-critic`; file: `.codex/skills/hypt-plan-critic/SKILL.md`)
