---
name: hypt-yolo
description: "Runs the complete shipping workflow through merge without stopping for confirmation. Use only when the user explicitly requests fully autonomous delivery."
metadata:
