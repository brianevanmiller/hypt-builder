---
name: hypt-go
description: "Runs the complete shipping workflow and asks for final confirmation before merging. Use when the user wants autonomous delivery with a merge gate."
metadata:
